								...
								<s:iterator var="o" value="pageBean.list" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												...
												<s:if test="#o.state == 3">未确认收货</s:if>
												<s:if test="#o.state == 4">交易完成</s:if>
												
											</td>
											<td align="center" style="HEIGHT: 22px">
												<input type="button" id="but<s:property value="#o.oid"/>" value="订单详情" onclick="showDetail(<s:property value="#o.oid"/>)">
					...
					<tr align="center">
						<td  colspan="4">
							...
							<s:if test="pageBean.page != 1">
								<a href="${pageContext.request.contextPath }/adminOrder_findAllByPage?page=1">首页</a>
